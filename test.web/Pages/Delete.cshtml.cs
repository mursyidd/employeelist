	...
	public class DeleteModel : PageModel
    {
        ...
        public async Task OnGet(int id)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
				...
				EmployeeModel = await JsonSerializer.DeserializeAsync<EmployeeModel>(contentStream);
            }
        }
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            using HttpResponseMessage response = await httpClient.DeleteAsync(EmployeeModel.id.ToString());
